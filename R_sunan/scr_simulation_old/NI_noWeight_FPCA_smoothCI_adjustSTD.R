...
results.lr = read_rds('data/nhanes_true_effect_lr_smoothed.rds') # true coefficients
...
cis = map2(
  ...
  nknots_min = 30 + L*0.75,
  nknots_fpca_min = 0.75*L,
  L = L
)
...
saveRDS(stats, file = paste0("results/NI/NI_noWeight_FPCA_smoothCI_adjustSTD", sim_id, ".rds"))