...
results.lr = read_rds('data/nhanes_true_effect_lr_smoothed_gam_default.rds') # true coefficients
...
saveRDS(stats, file = paste0("results/NI/case14_L1440_", sim_id, ".rds"))