...
files = list.files(here::here("results", "simulations", "survey_sim_smoothsens"), full.names = TRUE,
                   pattern = ".rds")
...
write_rds(all_res, here::here("results", "simulations", "all_survey_res_smoothsens.rds"))
