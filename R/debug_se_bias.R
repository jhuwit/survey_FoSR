...
outfile2 = here::here("debug", "bias_se_dfs", paste0("fold_se_", sprintf("%03d", ifold), ".rds"))
outfile3 = here::here("debug", "bias_se_dfs", paste0("fold_bias_", sprintf("%03d", ifold), ".rds"))
