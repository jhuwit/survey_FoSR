...
outfile2 = here::here("debug", "bias_se_dfs", paste0("fold_se_tst", sprintf("%03d", ifold), ".rds"))
outfile3 = here::here("debug", "bias_se_dfs", paste0("fold_bias_tst", sprintf("%03d", ifold), ".rds"))
