...
outfile = here::here("results", "simulations", "survey_sim3", paste0("fold_", sprintf("%03d", ifold), ".rds"))
# outfile2 = here::here("results", "simulations", "survey_sim3", paste0("fold_", sprintf("%03d", ifold), "_res.rds"))
# create partial dir to store ea. iteration

if (!dir.exists(dirname(outfile))) dir.create(dirname(outfile), recursive = TRUE)

partial_dir = here::here("results", "simulations", "survey_sim3", paste0("fold_", sprintf("%03d", ifold), "_partials"))
if (!dir.exists(partial_dir)) dir.create(partial_dir)

# partial_dir2 = here::here("results", "simulations", "survey_sim3", paste0("fold_", sprintf("%03d", ifold), "_partials2"))
