...
# sigma strata = .15 and sigma psu = 0.25 leads to good coverage of x, but not of intercept
...
write_rds(result, here::here("results", "simulations", "test1x.rds"))
write_rds(sim_all, here::here("results", "simulations", "test1x_all.rds"))
